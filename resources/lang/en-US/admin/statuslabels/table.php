...
return [
    ...
    'default_purchase_label' => 'Default Purchase Label',
    'default_purchase_label_help' => 'When this is checked, this status label will be applied to assets that are sold to employees via the asset purchase feature.',
